...
extern char *mix(const char *s1, const char *s2);
...
Test(TestsSuite, SampleTests)
{
	...
	dotest(
		...
		"2:mmmmmmmm/2:ssssss/1:eeeee/1:nnnnn/1:ttttt/2:ooooo/=:iiiii/1:wwww/2:aaaa/2:ffff/2:rrrr/1:dd/1:vv/2:hh/2:uu/2:xx"
	);
	dotest(
		"Earn extra honor and gain new allies: invite code warriors!",
		"Earn extra honor and gain new allies: invite code warriors!",
		"=:aaaaaa/=:nnnnnn/=:rrrrrr/=:eeeee/=:iiiii/=:oooo/=:dd/=:ll/=:ss/=:tt/=:ww"
	);
}
